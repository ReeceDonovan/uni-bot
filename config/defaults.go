...
func initDefaults() {
	...
	viper.SetDefault("canvas.aURL0", "https://ucc.instructure.com/api/v1/users/self/courses/")
	viper.SetDefault("canvas.aURL1", "/assignments?&order_by=due_at&access_token=")
